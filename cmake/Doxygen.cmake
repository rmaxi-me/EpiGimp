function(enable_doxygen)
  ...
  if(ENABLE_DOXYGEN)
    ...
    configure_file(${CMAKE_SOURCE_DIR}/Documentation/ExtraPages.hpp.in ${CMAKE_BINARY_DIR}/Documentation/ExtraPages.hpp
                   @ONLY)
    ...
    add_custom_target(
      conan_doc ALL
      COMMAND ${CONAN_CMD} info ${CMAKE_SOURCE_DIR} --graph=${CMAKE_BINARY_DIR}/Documentation/package.html
