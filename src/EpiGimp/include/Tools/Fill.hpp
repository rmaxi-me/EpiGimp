...
private:
    ...
    static constexpr float DIST_MAX = (255.0 * 255.0) + (255.0 * 255.0) + (255.0 * 255.0);
    ...
    void
    fill(const sf::Vector2i &pos, const sf::Color &color, const sf::Color &toReplace, const sf::Vector2u &size, std::size_t depth);
